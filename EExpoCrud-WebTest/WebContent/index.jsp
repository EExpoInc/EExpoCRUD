...
<body>
	...
	<div class="container">
		...
		<%
			...
			JpaDAO<UserEntity, Integer> jpaDAO = new JpaDAO<UserEntity, Integer>(UserEntity.class,
					Integer.class, persistenceUnit);
			
			final EExpoCrudCfg<UserEntity, Integer> cfg = new EExpoCrudCfg<UserEntity, Integer>(request,
					response, jpaDAO);
			...
			final EExpoRowButtonCfg<UserEntity> myCustomBtn2 = new EExpoRowButtonCfg<UserEntity>(
					new ActionableI<UserEntity>() {
						@Override
						public UserEntity action() {
							System.err.println(this.entity.id
									+ ":id - final EExpoRowButtonCfg<UserEntity> myCustomBtn2 :) ");
							return null;
						}
					});
